  ...
  class Process
    ...
    def initialize(@job, name)
      ...
      @fsm = StateMachine.new(
        ...
        start_proc: ->(start_chan : Channel(Nil), exit_chan : Channel(Nil)) { start_process(start_chan, exit_chan); nil },
    ...
    private def start_process(start_chan : Channel(Nil), exit_chan : Channel(Nil))
      begin
